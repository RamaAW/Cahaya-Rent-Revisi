...
@section('content')
    <div class="container">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nama" value="{{$review->nama}}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="date form-control" name="review" value="{{$review->review}}">
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Rating</label>
            <input type="text" class="date form-control" name="rating" value="{{$review->rating}}">
        </div>
